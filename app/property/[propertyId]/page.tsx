                ...
                <div className="w-[1312px] mx-auto">
                    <Dialog>
                        <div className="grid grid-cols-2 gap-3 pt-10">
                            ...
                            <div className="w-[20rem] h-[27rem] lg:w-[650px] hidden sm:grid sm:grid-cols-1 lg:grid-cols-2 gap-4 justify-items-start">
                                {url.map((element: string, index: number) => {
                                    return (
                                        (url.length > index + 1 && index + 1 < 5) && <DialogTrigger><img key={element} src={url[index + 1]} className={cn(index + 1 > 2 && 'hidden lg:inline')} alt="img" /></DialogTrigger>
                                    )
                                })}
                            </div>
                        </div>
                    ...
                    <div className="flex mx-auto ju space-x-16 py-6">
                        <div className="w-full lg:w-[865px] flex flex-col space-y-9 border-b-[1px]">
