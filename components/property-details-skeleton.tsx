      ...
      <div className="w-[1312px] mx-auto">
            ...
            <div>
              <Card className="w-[335px]">
                ...
                <CardContent className="flex space-y-3 flex-col">
                  <Button className="flex space-x-1 items-center justify-center w-full bg-white text-green-400 border border-green-500 rounded-[10px]">
                    <FaWhatsapp /> Whatshapp
                  </Button>
                  <Button className="flex space-x-1 items-center justify-center w-full bg-white text-red-400 border border-red-500 rounded-[10px]">
                    Request Callback
                  </Button>
                  <Button className="flex space-x-1 items-center justify-center w-full bg-red-500 text-white border border-red-500 rounded-[10px]">
                    View Mobile No.
                  </Button>
                </CardContent>
              </Card>
        ...
        <div className="h-[855px] flex flex-col space-y-4">
          ...
          <div className="flex flex-col space-y-2">
            ...
            <div className="w-[1312px] h-[485px] animate-pulse rounded-md bg-primary/10"></div>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4">
              <div className="flex space-x-1 items-center">
                ...
                <span className="text-[14px]">
                  Euro International School - 2 km
                </span>
              </div>
              <div className="flex space-x-1 items-center">
